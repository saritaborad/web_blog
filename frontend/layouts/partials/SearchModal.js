...
const SearchModal = ({ searchModal, setSearchModal }) => {
 ...
 return (
  <div className={`search-modal ${searchModal ? "open" : ""}`}>
   ...
   <input type="text" className="form-input bg-body placeholder:text-base dark:bg-darkmode-body" id="searchModal" placeholder="Type and hit enter..." onChange={(e) => setInput(e.target.value)} />
  </div>
 );
};

...
const ContactInfo = ({ info }) => {
 return (
  <div className="info bg-theme-dark dark:bg-light dark:border">
   <div className="info-main xxs:ml-4 sm:ml-10">
    ...
    <div className="info-content">
     <p className="info-t xxs:text-2xl lg:text-3xl text-light dark:text-darkmode-dark">{info?.cname || "Athh Tech"}</p>
    ...
    <div className="info-address mt-5">
     <p className="info-c mb-2 xxs:text-xl lg:text-2xl text-light dark:text-darkmode-dark">{info?.country || "india"}</p>
     <p className="info-a xxs:text-base lg:text-lg text-dark dark:text-darkmode-dark">{info?.address || "436, Mahek icon, Near- Sumul Dairy, Katargam road, Surat -Gujarat, INDIA"}</p>
    </div>
    ...
    <div className="info-icon mt-10">
     <div className="flex justify-between gap-4">
      ...
      <Link className="text-dark dark:text-darkmode-dark" href="https://athh.tech/" style={{ fontFamily: "Helvetica Now Display,sans-serif" }}>
       {info?.webLink || "https://athh.tech"}
      </Link>
     </div>
     <div className="flex justify-between gap-4">
      <img src="/images/email.png" />
      <Link className="text-dark dark:text-darkmode-dark" href={`mailto:${info?.email}`} style={{ fontFamily: "Helvetica Now Display,sans-serif" }}>
       {info?.email || "info@support.com"}
      </Link>
     </div>
     <div className="flex justify-between items-center gap-4">
      <img src="/images/telephone.png" />
      <Link className="text-dark dark:text-darkmode-dark" href={`tel:${info?.phone}`} style={{ fontFamily: "Helvetica Now Display,sans-serif" }}>

  ...
  <div className="info dark:bg-darkmode-primary">
   <div className="info-main xxs:ml-4 sm:ml-10">
    ...
    <div className="info-content">
     <p className="info-t xxs:text-2xl lg:text-3xl dark:text-darkmode-dark">{info?.cname || "Verselix"}</p>
    ...
    <div className="info-icon mt-10">
     <div className="flex justify-between gap-4">
      ...
      <Link className="dark:text-darkmode-dark" href="#" style={{ fontFamily: "Helvetica Now Display,sans-serif" }}>
       {info?.webLink || "verselix.io"}
      </Link>
     </div>
     <div className="flex justify-between gap-4">
      <img src="/images/email.png" />
      <Link className="dark:text-darkmode-dark" href={`mailto:${info?.email}`} style={{ fontFamily: "Helvetica Now Display,sans-serif" }}>
       {info?.email || "info@support.com"}
      </Link>
     </div>
     <div className="flex justify-between items-center gap-4">
      <img src="/images/telephone.png" />
      <Link className="dark:text-darkmode-dark" href={`tel:${info?.phone}`} style={{ fontFamily: "Helvetica Now Display,sans-serif" }}>
